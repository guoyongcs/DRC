...
class Loss(nn.modules.loss._Loss):
    def __init__(self, args, ckp):
        ...
        for loss in args.loss.split('+'):
            ...
            elif loss_type.find("GAN_G") >= 0 or loss_type.find("GAN_GP_G") >= 0:
                module = import_module('loss.adversarial_grad')
                loss_function = getattr(module, 'AdversarialGrad')(
                    args,
                    loss_type
                )
            elif loss_type.find("GAN") >= 0 or loss_type.find("GAN_GP") >= 0:
