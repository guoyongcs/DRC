...
parser.add_argument("-opt", type=str, default="options/setting2/test/test_setting2_x4_pruned.yml", help="Path to options YMAL file.")
parser.add_argument('--save_dir', type=str, default="../../../../experiment/DCLS_experiments")
args = parser.parse_args()
opt = option.parse(args.opt, is_train=False, exp_root=args.save_dir)
