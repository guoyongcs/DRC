...
def main():
    ...
    parser.add_argument("-opt", type=str, default="options/setting2/train/search_setting2_x4_drn.yml",
                        help="Path to option YMAL file.")
    parser.add_argument('--save_dir', type=str, default="../../../../experiment/1_DCLS_experiments/search_p07_wodual_1e-5")
    ...
    experiment = Search(args, model, train_loader, val_loader, prepro)
    experiment.search()
