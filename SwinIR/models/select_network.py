...
def define_G(opt):
    ...
    # ----------------------------------------
        ...
        netG = net(upscale=opt_net['upscale'],
                   ...
                   dual=opt_net['dual'] if 'dual' in opt_net else False)

    elif net_type == 'swinir_pruned':
        from models.network_swinir_pruned import SwinIR as net
        netG = net(upscale=opt_net['upscale'],
                   in_chans=opt_net['in_chans'],
                   img_size=opt_net['img_size'],
                   window_size=opt_net['window_size'],
                   ...
                   resi_connection=opt_net['resi_connection'],
                   dual=opt_net['dual'] if 'dual' in opt_net else False,
                   config_path=opt_net['config_path'],
                   pruning_rate=opt_net['pruning_rate']
                   )
