# channel number search for SwinIR-light-DRC
python main_search_swinir.py --opt_path options/swinir/search_swinir_sr_lightweight_drc.json --save_dir ../experiments/search_swinir_sr_lightweight_drc

# channel pruning for SwinIR-light-DRC
python main_pruning_swinir.py --opt_path options/swinir/pruning_swinir_sr_lightweight_drc.json --save_dir ../experiments/pruning_swinir_sr_lightweight_drc

# finetune SwinIR-light-DRC
