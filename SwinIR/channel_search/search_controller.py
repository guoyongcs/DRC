...
from models.network_swinir_pruned import WindowAttention, Mlp
...
class SearchController(nn.Module):
    ...
    def __init__(self, args, model, criterion, logger):
        ...
        # set alpha for search WindowAttention
    ...
    def count_layers(self, model):
        ...
        for module in model.modules():
            if isinstance(module, (WindowAttention, Mlp)):
                num_layers += 1
